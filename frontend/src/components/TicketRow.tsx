...
export function TicketRow({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md sm:p-5">
      {/* Linha 1: ticket, título, tipo, atualização e ações */}
      <div className="flex flex-wrap items-start justify-between gap-x-6 gap-y-3">
        ...
        <div className="flex shrink-0 items-center gap-4">
          <div className="min-w-[136px] whitespace-nowrap text-right">
      ...
      {/* Linha 4+: pipeline visual, uma linha por desenvolvimento Jira */}
